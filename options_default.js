...
var h = 600;
var w = h;
var pad = {left: 70, top: 140, right: 5, bottom: 105, middle: 120, text: 200 };
var corrInnerPad = 1;
var scatInnerPad = 10;
var radius = 5;
...
d3.select(self.frameElement).style("width", (w*2 + pad.left + pad.right + pad.middle + pad.text + 75) + "px");
d3.select(self.frameElement).style("height", (h + pad.top + pad.bottom + 20 + 80) + "px");
...
var scatTransTime = 200;  //time for transitions in the scatter plot

//specify instructions that will be displayed at the bottom of the page
var pos0 = { left: (pad.left)                  + "px",   top: (pad.top + h/2 + 80)    + "px" };
var pos1 = { left: (pad.left)                  + "px",   top: (pad.top + h + 40 + 80) + "px" };
var pos2 = { left: (pad.left + w + pad.middle) + "px",   top: (pad.top + h + 80 + 80) + "px" };
var pos3 = { left: (pad.left)                  + "px",   top: (pad.top + h + 22 + 80) + "px" };
var pos4 = { left: (pad.left+50)               + "px",   top: (pad.top + h + 40 + 80) + "px" };
